...
# Install classic package if not already installed
...
class ResumeAnalysisAgent:
    ...
    def analyze_skill(self, qa_chain, skill):
        ...
        f"proficiency in {skill}? Provide a numeric rating first, followed by reasoning."
    ...
    def analyze_resume_weaknesses(self):
        ...
        `   1. What's missing from the resume regarding this skill?
            ...
            try:
                ...
                # Store structured suggestions separately (as in your screenshot)
    ...
    def semantic_skill_analysis(self, resume_text, skills):
        ...
        # 1. Create vector store from resume
    ...
    def analyze_resume(self, resume_file, role_requirements=None, custom_jd=None):
        ...
        # 2. Save resume text to a temporary file (used internally if needed)
        ...
        # 5. If role requirements (skills list) are provided
        ...
        # 6. Analyze weaknesses if missing skills exist
        if (
    ...
    def improve_resume(self, improvement_areas, target_role=""):
        ...
        try:
            ...
            # =====================================================
            # 1️⃣ SKILLS HIGHLIGHTING (Rule-based, from weaknesses)
            # =====================================================
            for area in improvement_areas:
                if area == "Skills Highlighting" in improvement_areas and self.resume_weaknesses:
                    skill_improvements = {
            ...
            # =====================================================
            # 2️⃣ REMAINING IMPROVEMENT AREAS (LLM-based)
            # =====================================================
            remaining_areas = [
            ...
            if remaining_areas:
                ...
                # -----------------------------------------------------
                # 4️⃣ FALLBACK: Parse plain text if JSON fails
                # -----------------------------------------------------
            ...
            # =====================================================
            # 5️⃣ ENSURE ALL REQUESTED AREAS EXIST
            # =====================================================
            for area in improvement_areas:
                if area not in improvements:
                    improvements[area] = {
